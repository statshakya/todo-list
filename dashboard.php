...
<body>
  ...
  <div style="padding: 10px 20px; background-color: #fff;">
    ...
    <div class="dashboard-row">
      ...
      <div class="dashboard-card">
        ...
        <?php else: ?>
          <p class="card-subtext">No events scheduled for today</p>
          <a href="calendar.php" class="card-link">View Calendar →</a>
        <?php endif; ?>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    function updateHeader() {
      const now = new Date();
      const weekdayFull = now.toLocaleDateString('en-GB', { weekday: 'short' });
